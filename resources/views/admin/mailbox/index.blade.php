...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-3">
                <a href="{{ route('admin.mailBox.create')}}" class="btn btn-primary btn-block mb-3">Compose</a>
                            ...
                            <table class="table table-hover table-striped">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="mailbox-name"><a href="{{ route('admin.mailBox.show',1) }}">Alexander Pierce</a></td>
